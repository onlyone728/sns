...
<body>
<a href="#user-menu-area" id="modalBtn" class="btn btn-danger">모달</a>
	...
	<a href="modal:open" id="postMenuBtn" class="btn btn-secondary">버튼</a>
		<div class="modal">
			<ul id="postMenu">
	...
	<svg aria-label="댓글 달기" class="_8-yf5 " color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 10-3.59 3.615L22 22z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
	<svg aria-label="저장" class="_8-yf5 " color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
	...
	<div class="RJJyf_1gKD_" role="button"><button class="sqdOP yWX7d y3zKF" type="button"><div class="qF0y9 Igw0E rBNOH YBx95 ybXk5 _4EzTm lC6p0 HVWg4"><svg aria-label="자르기 선택" class="_8-yf5 " color="#ffffff" fill="#ffffff" height="16" role="img" viewBox="0 0 24 24" width="16"><path d="M10 20H4v-6a1 1 0 00-2 0v7a1 1 0 001 1h7a1 1 0 000-2zM20.999 2H14a1 1 0 000 2h5.999v6a1 1 0 002 0V3a1 1 0 00-1-1z"></path></svg></div></button></div>
