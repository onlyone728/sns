	...
	<div class="post-card">
		<div class="post-info d-flex justify-content-between align-items-center">
			...
			<div class="card-option pt-2 pr-2">
				<a href="modal:open" class="postMenuBtn" data-post-id="${content.post.id}">
		...
		<div class="post-option d-flex justify-content-between">
			<div class="d-flex">
				...
				<c:choose>
					...
					<c:when test="${content.filledLike == true}">	
						<a href="#" class="likeDelBtn" data-post-id="${content.post.id}">
				...
				<div id="post-detail-btn" class="mr-3">
					<a href="#">
						<svg aria-label="댓글 달기" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 10-3.59 3.615L22 22z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
					</a>
				</div>
			...
			<div id="save-btn">
				<a href="#">
					<svg aria-label="저장" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
				</a>
			</div>
		</div>
		...
		<%-- 좋아요 영영 --%>
			...
			<div class="like-count ml-3 mb-2"><b>좋아요 ${content.likeCount}개</b></div>
